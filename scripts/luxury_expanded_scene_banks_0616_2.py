...
PREFIX_PROFILES: dict[str, PrefixProfile] = {
    ...
    "L048": PrefixProfile("kitchen_storage", "home storage organizer", "frame, shelves, rods, connectors, color, outline and visible hardware", "on counter, shelf, sideboard or storage cabinet surface"),
    "L051": PrefixProfile("kitchen_storage", "household organizer rack", "rack frame, tiers, rods, handles, supports, color and silhouette", "on a kitchen counter, pantry shelf or utility sideboard"),
    ...
    "L068": PrefixProfile("kitchen_storage", "storage organizer or rack", "organizer body, compartments, shelves, frame, supports and color", "on kitchen, pantry, closet or sideboard support surface"),
    ...
    "L074": PrefixProfile("kitchen_storage", "compact household storage organizer", "body, tiers, panels, rods, supports, color and outline", "on counter, shelf, sideboard or cabinet surface"),
    "L075": PrefixProfile("kitchen_storage", "home organizer rack", "rack body, tiers, rods, frame, supports and visible hardware", "on kitchen, pantry, laundry or storage counter"),
    ...
    "L077": PrefixProfile("kitchen_storage", "household storage organizer", "frame, compartments, shelves, handles, supports and silhouette", "on a realistic counter, shelf, cabinet or sideboard"),
    "L078": PrefixProfile("kitchen_storage", "handled household organizer", "top black handle, tray or lid structure, body outline and proportions", "on counter, shelf, storage cabinet or sideboard surface"),
    ...
    "L083": PrefixProfile("kitchen_storage", "storage rack or organizer", "overall proportion, side straight rods, metal plate/sheet details, supports, connectors and frame geometry", "on a shelf, cabinet, pantry or storage surface"),
    "L085": PrefixProfile("kitchen_storage", "household storage rack", "rack frame, trays, rods, supports, connectors, color and proportions", "on kitchen, pantry, utility or sideboard support surface"),
    ...
    "L087": PrefixProfile("kitchen_storage", "household organizer with fixed dimensions", "source dimensions, width-height relationship, visible parts, frame and proportions", "on a correct home storage support surface"),
