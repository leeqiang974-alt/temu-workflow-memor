...
Local repository remote is configured as `https://github.com/leeqiang974-alt/temu-workflow-memor.git`.

If direct `git push` fails due local network or credential issues, use the GitHub connector/API to write the tracked docs and then reconcile local git later.
