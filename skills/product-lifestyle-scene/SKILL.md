...
- **L043 folding clothes stacking board**: high risk for source-material sameness and scale drift. Do not use one unified-looking PNG across all L043 exact D values. For any L043 redo, do not continue editing the failed generated image and do not reuse that failed candidate's source PNG; choose a different approved PNG/source_id for that exact D. Use larger inspection scale, about 34-40% of image height, with a clean front/top-front view. Do not mirror, rotate, or redraw the board. Freeze the flat folding board outline, exact hole count, all large holes, the small center hole, rear raised detail, front raised detail, panel seams, material, and thin board thickness. Clothing may sit nearby but must not cover any hole. Reject outputs where the board becomes a generic tray/pad, loses rear raised detail, changes hole positions/count, loses the small center hole, or appears unrealistically huge/small next to garments. If available L043 cutouts are too uniform or all attempted sources fail, pause to select better source PNGs or use fixed-PNG compositing rather than hallucinating variety.
...
- **L083 sliding under-sink cabinet rack**: high appearance-drift risk and not a generic countertop organizer. Use only under-sink cabinet, vanity lower cabinet, lower storage bay, or enclosed cabinet-interior scenes. Freeze the overall proportion, side straight rods, sliding basket/plate details, supports, connectors, frame geometry, and visible hardware. Reject open countertop/sideboard scenes, added side-rod details, changed surface plate, ratio drift, or generic rack conversion.
...
- **L096 folding portable barbecue grill**: this is an outdoor cooking product, not a kitchen-counter storage item. Use only clearly outdoor contexts with visible outdoor cues: lawn, balcony railing, patio pavers, terrace, garden plants, deck boards, open sky, outdoor chairs, or picnic table. Every L096 prompt must include at least three clear cues from the outdoor whitelist: lawn, balcony railing, patio pavers, terrace, garden plants, deck boards, open sky. Preferred supports are wooden picnic table, metal balcony table, patio table, camping table, garden workbench, or outdoor dining table. Avoid ambiguous wording such as `stone counter`, `sideboard`, `outdoor cabinet`, `prep counter`, or `cooking station` because the model may turn it into an indoor kitchen counter. Never place it on an indoor kitchen counter, pantry shelf, bedroom, closet, sofa, bathroom, generic decorative surface, kitchen island, sink area, appliance corner, or cabinet scene. Keep folding grill body, frame, legs, grate, hinge/locking structure, panels, supports, color, and silhouette unchanged. Avoid open flame, smoke, lit charcoal, candles, alcohol, branded packaging, and electronics; show the grill folded or being prepared before use on a heat-safe outdoor support surface.
